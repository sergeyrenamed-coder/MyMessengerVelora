...
function updateComposerAvailability() {
  ...
  els.composerInput.disabled = blocked;
  els.attachButton.disabled = blocked;
  if (els.videoNoteButton) els.videoNoteButton.disabled = blocked;
  els.voiceButton.disabled = blocked;
  els.mediaPanelToggle.disabled = blocked;
...
async function refreshChatsFromApi() {
